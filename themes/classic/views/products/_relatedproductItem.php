    ...
    <div class="product-thumb transition">
        <div class="image">
            <a href="<?php echo UsniAdaptor::createUrl('/catalog/products/site/detail', ['id' => $model['id']]); ?>">
                <?php echo FileUploadUtil::getThumbnailImage($model, 'image', ['cssClass' => 'img-responsive', 
        ...
        <?php
            $requiredOptionsCount = ProductUtil::doesProductHaveRequiredOptions($model['id']);
            ...
            ?>
                ...
                {
                ?>
                <button type="button" data-toggle="tooltip" title="<?php echo $addWishListLabel;?>" class="product-wishlist" data-productid = "<?php echo $model['id'];?>">
                ...
                {
                ?>
                <button type="button" data-toggle="tooltip" title="<?php echo $addCompareLabel;?>" class="add-product-compare" data-productid = "<?php echo $model['id'];?>">
