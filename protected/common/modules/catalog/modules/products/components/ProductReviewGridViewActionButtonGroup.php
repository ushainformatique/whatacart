...
class ProductReviewGridViewActionButtonGroup extends TranslatableGridViewActionButtonGroup
{
    ...
    protected function renderBulkApproveButton()
    {
        ...
        if(AuthManager::checkAccess(UsniAdaptor::app()->user->getUserModel(), $modelClass . '.approve'))
        {
            $content         = null;
    ...
    protected function renderBulkDeleteButton()
    {
        ...
        if($this->actionToolbar->showBulkDelete && AuthManager::checkAccess($user, $modelClassName . '.delete'))
        {
