 ...
 */
namespace common\modules\localization\modules\language\components;
 ...
 */
class LanguageActionColumn extends UiActionColumn
{
    /**
     * @inheritdoc
     */
    ...
    {
        $isAllowed = LanguageUtil::checkIfAllowedToDelete($model);
        if($isAllowed)
        {
