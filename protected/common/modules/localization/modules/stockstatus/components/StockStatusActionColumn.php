 ...
 */
namespace common\modules\localization\modules\stockstatus\components;
...
/**
 * StockStatusActionColumn class file.
 *
 * @package common\modules\localization\modules\stockstatus\components
 */
class StockStatusActionColumn extends UiActionColumn
{
    /**
     * @inheritdoc
     */
    ...
    {
        $isAllowed = StockStatusUtil::checkIfAllowedToDelete($model);
        if($isAllowed)
        {
