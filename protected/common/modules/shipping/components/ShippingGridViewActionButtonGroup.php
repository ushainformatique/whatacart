...
/**
 * ShippingGridViewActionButtonGroup class file.
 * 
 * @package common\modules\shipping\components
 */
class ShippingGridViewActionButtonGroup extends TranslatableGridViewActionButtonGroup
{
    /**
     * @inheritdoc
     */
    ...
    protected function renderReloadButton()
    {
        ...
        if(AuthManager::checkAccess(UsniAdaptor::app()->user->getUserModel(), $modelClass . '.manage'))
        {
            ...
            $reloadUrl       = UsniAdaptor::createUrl('/shipping/default/reload');
